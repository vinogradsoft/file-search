...
class TargetHandlerTest extends ProxyVisitorCase
{
    private $strategy;
    private $factory;
    private $detect;
    ...
    public function testEquals()
    {
        ...
        self::assertTrue($proxyVisitor->equals($this));
        self::assertFalse($proxyVisitor->equals($this->getMockForAbstractClass(Visitor::class)));
    }
